...
import { sampleWithRequiredData } from '../musteri.test-samples';
...
describe('Musteri Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.musteris?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to musteriService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMusteriIdentifier');
      const id = comp.trackId(entity);
      expect(service.getMusteriIdentifier).toHaveBeenCalledWith(entity);
